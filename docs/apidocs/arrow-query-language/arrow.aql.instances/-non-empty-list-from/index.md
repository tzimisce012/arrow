---
title: NonEmptyListFrom - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [NonEmptyListFrom](./index.html)

# NonEmptyListFrom

`@extension interface NonEmptyListFrom : `[`From`](../../arrow.aql/-from/index.html)`<ForNonEmptyList>`

### Functions

| [applicative](applicative.html) | `open fun applicative(): Applicative<ForNonEmptyList>` |
