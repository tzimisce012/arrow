---
title: SequenceKEachInstance.each - arrow-optics
---

[arrow-optics](../../index.html) / [arrow.optics.instances](../index.html) / [SequenceKEachInstance](index.html) / [each](./each.html)

# each

`open fun each(): `[`Traversal`](../../arrow.optics/-traversal.html)`<SequenceK<`[`A`](index.html#A)`>, `[`A`](index.html#A)`>`
