---
title: Tuple6 - arrow-core
---

[arrow-core](../../index.html) / [arrow.core](../index.html) / [Tuple6](./index.html)

# Tuple6

`@higherkind data class Tuple6<out A, out B, out C, out D, out E, out F> : `[`Tuple6Of`](../-tuple6-of.html)`<`[`A`](index.html#A)`, `[`B`](index.html#B)`, `[`C`](index.html#C)`, `[`D`](index.html#D)`, `[`E`](index.html#E)`, `[`F`](index.html#F)`>`

### Constructors

| [&lt;init&gt;](-init-.html) | `Tuple6(a: `[`A`](index.html#A)`, b: `[`B`](index.html#B)`, c: `[`C`](index.html#C)`, d: `[`D`](index.html#D)`, e: `[`E`](index.html#E)`, f: `[`F`](index.html#F)`)` |
