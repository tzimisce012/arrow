---
title: OptionFrom - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [OptionFrom](./index.html)

# OptionFrom

`@extension interface OptionFrom : `[`From`](../../arrow.aql/-from/index.html)`<ForOption>`

### Functions

| [applicative](applicative.html) | `open fun applicative(): Applicative<ForOption>` |
