---
title: Tuple2 - arrow-core
---

[arrow-core](../../index.html) / [arrow.core](../index.html) / [Tuple2](./index.html)

# Tuple2

`@higherkind data class Tuple2<out A, out B> : `[`Tuple2Of`](../-tuple2-of.html)`<`[`A`](index.html#A)`, `[`B`](index.html#B)`>`

### Constructors

| [&lt;init&gt;](-init-.html) | `Tuple2(a: `[`A`](index.html#A)`, b: `[`B`](index.html#B)`)` |
...
| [ap](ap.html) | `fun <C> ap(f: `[`Tuple2Of`](../-tuple2-of.html)`<*, (`[`B`](index.html#B)`) -> `[`C`](ap.html#C)`>): `[`Tuple2`](./index.html)`<`[`A`](index.html#A)`, `[`C`](ap.html#C)`>` |
| [bimap](bimap.html) | `fun <C, D> bimap(fl: (`[`A`](index.html#A)`) -> `[`C`](bimap.html#C)`, fr: (`[`B`](index.html#B)`) -> `[`D`](bimap.html#D)`): `[`Tuple2`](./index.html)`<`[`C`](bimap.html#C)`, `[`D`](bimap.html#D)`>` |
| [coflatMap](coflat-map.html) | `fun <C> coflatMap(f: (`[`Tuple2Of`](../-tuple2-of.html)`<`[`A`](index.html#A)`, `[`B`](index.html#B)`>) -> `[`C`](coflat-map.html#C)`): `[`Tuple2`](./index.html)`<`[`A`](index.html#A)`, `[`C`](coflat-map.html#C)`>` |
| [extract](extract.html) | `fun extract(): `[`B`](index.html#B) |
| [flatMap](flat-map.html) | `fun <C> flatMap(f: (`[`B`](index.html#B)`) -> `[`Tuple2Of`](../-tuple2-of.html)`<`[`A`](index.html#A)`, `[`C`](flat-map.html#C)`>): `[`Tuple2`](./index.html)`<`[`A`](index.html#A)`, `[`C`](flat-map.html#C)`>` |
| [foldL](fold-l.html) | `fun <C> foldL(b: `[`C`](fold-l.html#C)`, f: (`[`C`](fold-l.html#C)`, `[`B`](index.html#B)`) -> `[`C`](fold-l.html#C)`): `[`C`](fold-l.html#C) |
| [foldR](fold-r.html) | `fun <C> foldR(lb: `[`Eval`](../-eval/index.html)`<`[`C`](fold-r.html#C)`>, f: (`[`B`](index.html#B)`, `[`Eval`](../-eval/index.html)`<`[`C`](fold-r.html#C)`>) -> `[`Eval`](../-eval/index.html)`<`[`C`](fold-r.html#C)`>): `[`Eval`](../-eval/index.html)`<`[`C`](fold-r.html#C)`>` |
| [map](map.html) | `fun <C> map(f: (`[`B`](index.html#B)`) -> `[`C`](map.html#C)`): `[`Tuple2`](./index.html)`<`[`A`](index.html#A)`, `[`C`](map.html#C)`>` |
| [reverse](reverse.html) | `fun reverse(): `[`Tuple2`](./index.html)`<`[`B`](index.html#B)`, `[`A`](index.html#A)`>` |
...
| [toPair](../to-pair.html) | `fun <K, V> `[`Tuple2`](./index.html)`<`[`K`](../to-pair.html#K)`, `[`V`](../to-pair.html#V)`>.toPair(): `[`Pair`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-pair/index.html)`<`[`K`](../to-pair.html#K)`, `[`V`](../to-pair.html#V)`>` |
