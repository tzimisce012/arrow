---
title: Function0From - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [Function0From](./index.html)

# Function0From

`@extension interface Function0From : `[`From`](../../arrow.aql/-from/index.html)`<ForFunction0>`

### Functions

| [applicative](applicative.html) | `open fun applicative(): Applicative<ForFunction0>` |
