---
title: EitherGroupBy - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [EitherGroupBy](./index.html)

# EitherGroupBy

`@extension interface EitherGroupBy<L> : `[`GroupBy`](../../arrow.aql/-group-by/index.html)`<EitherPartialOf<`[`L`](index.html#L)`>>`
