---
title: Tuple4 - arrow-core
---

[arrow-core](../../index.html) / [arrow.core](../index.html) / [Tuple4](./index.html)

# Tuple4

`@higherkind data class Tuple4<out A, out B, out C, out D> : `[`Tuple4Of`](../-tuple4-of.html)`<`[`A`](index.html#A)`, `[`B`](index.html#B)`, `[`C`](index.html#C)`, `[`D`](index.html#D)`>`

### Constructors

| [&lt;init&gt;](-init-.html) | `Tuple4(a: `[`A`](index.html#A)`, b: `[`B`](index.html#B)`, c: `[`C`](index.html#C)`, d: `[`D`](index.html#D)`)` |
