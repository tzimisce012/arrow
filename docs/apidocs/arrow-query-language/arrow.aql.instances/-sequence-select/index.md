---
title: SequenceSelect - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [SequenceSelect](./index.html)

# SequenceSelect

`@extension interface SequenceSelect : `[`Select`](../../arrow.aql/-select/index.html)`<ForSequenceK>`

### Functions

| [functor](functor.html) | `open fun functor(): Functor<ForSequenceK>` |
