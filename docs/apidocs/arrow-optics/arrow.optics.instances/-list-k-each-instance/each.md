---
title: ListKEachInstance.each - arrow-optics
---

[arrow-optics](../../index.html) / [arrow.optics.instances](../index.html) / [ListKEachInstance](index.html) / [each](./each.html)

# each

`open fun each(): `[`Traversal`](../../arrow.optics/-traversal.html)`<ListK<`[`A`](index.html#A)`>, `[`A`](index.html#A)`>`
