---
title: HigherKindsProcessor - arrow-annotations-processor
---

[arrow-annotations-processor](../../index.html) / [arrow.higherkinds](../index.html) / [HigherKindsProcessor](./index.html)

# HigherKindsProcessor

`@AutoService([Processor]) class HigherKindsProcessor : `[`AbstractProcessor`](../../arrow.common.utils/-abstract-processor/index.html)

### Constructors

| [&lt;init&gt;](-init-.html) | `HigherKindsProcessor()` |
