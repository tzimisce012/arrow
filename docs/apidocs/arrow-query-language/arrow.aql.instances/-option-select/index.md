---
title: OptionSelect - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [OptionSelect](./index.html)

# OptionSelect

`@extension interface OptionSelect : `[`Select`](../../arrow.aql/-select/index.html)`<ForOption>`

### Functions

| [functor](functor.html) | `open fun functor(): Functor<ForOption>` |
