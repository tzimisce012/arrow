---
title: TrySelect - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [TrySelect](./index.html)

# TrySelect

`@extension interface TrySelect : `[`Select`](../../arrow.aql/-select/index.html)`<ForTry>`

### Functions

| [functor](functor.html) | `open fun functor(): Functor<ForTry>` |
