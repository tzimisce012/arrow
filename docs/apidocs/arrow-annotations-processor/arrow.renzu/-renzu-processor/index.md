---
title: RenzuProcessor - arrow-annotations-processor
---

[arrow-annotations-processor](../../index.html) / [arrow.renzu](../index.html) / [RenzuProcessor](./index.html)

# RenzuProcessor

`@AutoService([Processor]) class RenzuProcessor : `[`AbstractProcessor`](../../arrow.common.utils/-abstract-processor/index.html)

### Constructors

| [&lt;init&gt;](-init-.html) | `RenzuProcessor(isolateForTests: `[`Boolean`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)` = false)` |

### Properties

| [annotatedList](annotated-list.html) | `val annotatedList: `[`MutableList`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-mutable-list/index.html)`<`[`AnnotatedInstance`](../../arrow.instances/-annotated-instance/index.html)`>` |
