---
title: SequenceSum - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [SequenceSum](./index.html)

# SequenceSum

`@extension interface SequenceSum : `[`Sum`](../../arrow.aql/-sum/index.html)`<ForSequenceK>`
