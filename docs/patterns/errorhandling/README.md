...
Option.monadError()
// arrow.instances.option.monadError.OptionMonadErrorInstanceKt$monadError$1@1ab3da4a
```
...
Try.monadError()
// arrow.instances.try.monadError.TryMonadErrorInstanceKt$monadError$1@51fd660b
```
...
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@4c191283
```
