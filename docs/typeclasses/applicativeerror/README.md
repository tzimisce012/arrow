...
|__arrow.data__|[Kleisli]({{ '/docs/arrow/data/kleisli' | relative_url }}), [StateT]({{ '/docs/arrow/data/statet' | relative_url }}), [Validated]({{ '/docs/arrow/data/validated' | relative_url }})|
