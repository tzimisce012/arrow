...
interface ComposedApplicative<F, G> : Applicative<Nested<F, G>>, ComposedFunctor<F, G> {
  ...
  companion object {
    operator fun <F, G> invoke(FF: Applicative<F>, GF: Applicative<G>): Applicative<Nested<F, G>> =
...
interface ComposedAlternative<F, G> : Alternative<Nested<F, G>>, ComposedApplicative<F, G>, ComposedMonoidK<F, G> {
  ...
  companion object {
    operator fun <F, G> invoke(AF: Alternative<F>, AG: Applicative<G>): Alternative<Nested<F, G>> =
