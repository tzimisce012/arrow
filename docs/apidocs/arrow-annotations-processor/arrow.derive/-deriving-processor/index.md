---
title: DerivingProcessor - arrow-annotations-processor
---

[arrow-annotations-processor](../../index.html) / [arrow.derive](../index.html) / [DerivingProcessor](./index.html)

# DerivingProcessor

`@AutoService([Processor]) class DerivingProcessor : `[`AbstractProcessor`](../../arrow.common.utils/-abstract-processor/index.html)

### Constructors

| [&lt;init&gt;](-init-.html) | `DerivingProcessor()` |
