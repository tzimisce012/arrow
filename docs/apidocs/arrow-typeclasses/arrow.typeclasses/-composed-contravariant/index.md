---
title: ComposedContravariant - arrow-typeclasses
---

[arrow-typeclasses](../../index.html) / [arrow.typeclasses](../index.html) / [ComposedContravariant](./index.html)

# ComposedContravariant

`interface ComposedContravariant<F, G> : `[`Functor`](../-functor/index.html)`<`[`Nested`](../-nested.html)`<`[`F`](index.html#F)`, `[`G`](index.html#G)`>>`
...
| [invoke](invoke.html) | `operator fun <F, G> invoke(FF: `[`Contravariant`](../-contravariant/index.html)`<`[`F`](invoke.html#F)`>, GF: `[`Contravariant`](../-contravariant/index.html)`<`[`G`](invoke.html#G)`>): `[`Functor`](../-functor/index.html)`<`[`Nested`](../-nested.html)`<`[`F`](invoke.html#F)`, `[`G`](invoke.html#G)`>>` |
