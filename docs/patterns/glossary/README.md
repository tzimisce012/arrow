...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@2e01edc0
```

```kotlin
Option.functor()
// arrow.instances.option.functor.OptionFunctorInstanceKt$functor$1@779992a5
```
...
// arrow.instances.mapk.semigroup.MapKSemigroupInstanceKt$semigroup$1@23422836
```

```kotlin
Either.monadError<Throwable>()
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@2f484c2e
```

```kotlin
ListK.traverse()
// arrow.instances.listk.traverse.ListKTraverseInstanceKt$traverse$2@75a78aea
```
...
ListK.functor()
// arrow.instances.listk.functor.ListKFunctorInstanceKt$functor$1@5ec0372f
```
