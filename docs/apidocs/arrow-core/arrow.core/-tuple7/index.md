---
title: Tuple7 - arrow-core
---

[arrow-core](../../index.html) / [arrow.core](../index.html) / [Tuple7](./index.html)

# Tuple7

`@higherkind data class Tuple7<out A, out B, out C, out D, out E, out F, out G> : `[`Tuple7Of`](../-tuple7-of.html)`<`[`A`](index.html#A)`, `[`B`](index.html#B)`, `[`C`](index.html#C)`, `[`D`](index.html#D)`, `[`E`](index.html#E)`, `[`F`](index.html#F)`, `[`G`](index.html#G)`>`

### Constructors

| [&lt;init&gt;](-init-.html) | `Tuple7(a: `[`A`](index.html#A)`, b: `[`B`](index.html#B)`, c: `[`C`](index.html#C)`, d: `[`D`](index.html#D)`, e: `[`E`](index.html#E)`, f: `[`F`](index.html#F)`, g: `[`G`](index.html#G)`)` |
