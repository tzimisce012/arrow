---
title: Tuple3 - arrow-core
---

[arrow-core](../../index.html) / [arrow.core](../index.html) / [Tuple3](./index.html)

# Tuple3

`@higherkind data class Tuple3<out A, out B, out C> : `[`Tuple3Of`](../-tuple3-of.html)`<`[`A`](index.html#A)`, `[`B`](index.html#B)`, `[`C`](index.html#C)`>`

### Constructors

| [&lt;init&gt;](-init-.html) | `Tuple3(a: `[`A`](index.html#A)`, b: `[`B`](index.html#B)`, c: `[`C`](index.html#C)`)` |
...
| [reverse](reverse.html) | `fun reverse(): `[`Tuple3`](./index.html)`<`[`C`](index.html#C)`, `[`B`](index.html#B)`, `[`A`](index.html#A)`>` |
