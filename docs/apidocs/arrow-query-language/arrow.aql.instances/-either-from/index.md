---
title: EitherFrom - arrow-query-language
---

[arrow-query-language](../../index.html) / [arrow.aql.instances](../index.html) / [EitherFrom](./index.html)

# EitherFrom

`@extension interface EitherFrom<L> : `[`From`](../../arrow.aql/-from/index.html)`<EitherPartialOf<`[`L`](index.html#L)`>>`

### Functions

| [applicative](applicative.html) | `open fun applicative(): Applicative<EitherPartialOf<`[`L`](index.html#L)`>>` |
